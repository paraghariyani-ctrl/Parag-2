              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    ...
                    'Cloud restore can be connected later.',
...
class _QuotationEditorPageState extends State<QuotationEditorPage>{
  ...
  Future<void> addEvent() async {
    ...
    String selectedEvent = eventOptions.first;
    String selectedSide = 'Both Side';
      ...
      setState(() {
        events.add(
          QuotationEvent(
            ...
            event: selectedEvent,
            side: selectedSide,
            requirements: Map<String, int>.from(requirements),
          ),
        );
      });
    }
  ...
  Future<void> manageTcs() async {
    ...
    final result = await showDialog<String>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title: const Text('Add T&C Template'),
          content: TextField(
    ...
    widget.onTemplatesChanged(List<String>.from(tcs));
  }

  Future<void> saveQ() async {
    ...
    final quotation = Quotation(
      ...
      createdDate: widget.initial?.createdDate ?? fmt(DateTime.now()),
      events: events,
      deliverables: dels,
      shootCharges: num(shoot),
      editingCharges: num(editing),
      albums: albums,
      tnc: tnc.text.trim(),
    );

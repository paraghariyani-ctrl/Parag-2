...
class LoginPage extends StatefulWidget { final VoidCallback onLogin; LoginPage({super.key,required this.onLogin}); @override State<LoginPage> createState()=>_LoginPageState(); }
...
class CrewFlowHome extends StatefulWidget {
  ...
  CrewFlowHome({super.key, required this.dark, required this.onDark, this.onLogout});
  @override
...
class _CrewFlowHomeState extends State<CrewFlowHome> {
  ...
  Widget teamPage() => Stack(children: [
        ...
        Positioned(right: 18, bottom: 18, child: FloatingActionButton(heroTag: 'teamAdd', onPressed: addTeamMember, child: const Icon(Icons.add))),
      ]);
  ...
  Future<void> addTeamMember() async {
    ...
    final exists = team.any(
      (m) => m.phone.replaceAll(RegExp(r'\D'), '') ==
...
class EventDialog extends StatefulWidget {
  ...
  EventDialog({super.key, this.existing, this.initialDate, required this.groupEvents, required this.team, this.onDelete});
  @override
      ...
      child: SizedBox(
        ...
        child: Column(children: [
          ...
          Expanded(child: SingleChildScrollView(padding: const EdgeInsets.fromLTRB(20, 4, 20, 8), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            TextField(controller: client, textInputAction: TextInputAction.next, decoration: const InputDecoration(labelText: 'Client Name', prefixIcon: Icon(Icons.person_outline))),
...
class AssignMemberDialog extends StatefulWidget {
  ...
  AssignMemberDialog({super.key, required this.role, required this.members, required this.already});
  @override
...
class QuotationListPage extends StatefulWidget {
  ...
  QuotationListPage({super.key,required this.quotations,required this.profile,required this.tcTemplates,required this.onChanged});
...
class QuotationEditorPage extends StatefulWidget {
  ...
  QuotationEditorPage({super.key,this.initial,required this.profile,required this.tcTemplates,required this.onTemplatesChanged});
...
class QuotationPdfPage extends StatelessWidget {
  ...
  QuotationPdfPage({super.key,required this.quotation,required this.profile});
...
class EventPdfPage extends StatelessWidget {
  ...
  final List<TeamMember> team;
  EventPdfPage({super.key, required this.events, required this.profile, required this.team});

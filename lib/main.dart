...
class _CrewFlowAppState extends State<CrewFlowApp> {
  ...
  Widget build(BuildContext context) => MaterialApp(
        ...
        home: CrewFlowHome(dark: dark, onDark: toggle),
      );
}
...
class CrewFlowHome extends StatefulWidget {
  ...
  const CrewFlowHome({super.key, required this.dark, required this.onDark});
  @override
...
class _EventDialogState extends State<EventDialog> {
  ...
  @override
  Widget build(BuildContext context) {
    final maxHeight = (MediaQuery.sizeOf(context).height - 48).clamp(420.0, 760.0);
    return Dialog(
